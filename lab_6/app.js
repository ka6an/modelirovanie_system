...
var mas1 = [], mas2 = [], mas3 = [], mas4 = [], mas_1 = [], mas_2 = [], masP = [], select_mas = [], N = 30000, M = 100, alpha = 0.6, h = 0.02, d, m, s_0, k_f, t_f;
masP[0] = 2.7;
masP[1] = 4.6;
masP[2] = 6.3;
masP[3] = 7.8;
