...
function fun_1(amount, arr_z, m, chart_div, p, num) {
    ...
    for (var k = 0; k < m; k++) {
        ...
        // console.log('arr_table[3][k] = ', arr_table[3][k]);
    }
    ...
    for (var i = 0; i < m; i++) {
        if (arr_table[0][i] > 0.5) {
            ...
            // console.log('p_j1= ', p_j);
            // console.log('arr_table1= ', arr_table[0][i]);
            // console.log('arr_table2= ', arr_table[1][i]);
        }
        else {
            p_j = arr_table[0][i] - arr_table[1][i];
            // console.log('p_j2= ', p_j);
        }
        hi += ((arr_table[4][i] - p_j) * (arr_table[4][i] - p_j)) / p_j;
        // console.log('arr_table[4][i] = ', arr_table[4][i]);
    }
